...
window.addEventListener("scroll", function(){
  ...
  if(window.scrollY>0){
      div1.className="menu sticky-top"
      div.classList.add("margin");
      div.classList.remove("pb-4");

  }
  else if(window.scrollY==0){
      div1.className="sticky-top"
      div.classList.add("pb-4");
      div.classList.remove("margin");
  }
...
while (true) {
await node.type('Front-end Developer')
await sleep(3000)
await node.delete('Front-end Developer')
await node.type('Mentor')
await sleep(3000)
